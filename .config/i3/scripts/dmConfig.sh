...
"i3-autostart           | $HOME/.config/i3/config.d/autostart"
"i3-bar                 | $HOME/.config/i3/config.d/i3bar"
"i3-keybindings         | $HOME/.config/i3/config.d/keybindings"
...
"i3status-primary       | $HOME/.config/i3status-rust/config_primary.toml"
"i3status-nonprimary    | $HOME/.config/i3status-rust/config_nonprimary.toml"
