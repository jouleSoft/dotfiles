...
"i3-dmApplcations       | $HOME/.config/i3/dmApplications.sh"
"i3-dmConfig            | $HOME/.config/i3/dmConfig.sh"
"i3-dmDocs              | $HOME/.config/i3/dmDocs.sh"
"i3-dmScripts           | $HOME/.config/i3/dmScripts.sh"
"i3-dmUrl               | $HOME/.config/i3/dmUrl.sh"
"i3-dunstify-volume     | $HOME/.config/i3/dunstify-volume.sh"
